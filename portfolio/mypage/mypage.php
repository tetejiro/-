  ...
  <form action="mypage-branch.php" method="post">
    <div class="zenhan">
      <div class="zenhan1">
        <div class="now">
          今は何をしていますか？ <br><br>
          <textarea class="area" name="task"><?php if (empty($task) == false) {
            print $task; } ?></textarea><br><br><br>
        </div>
        <!--now-->
        <div class="time">
          どれくらいかかりそうですか？ <br><br>
          <input type="time" name="bytime1" value="<?php if (empty($bytime1) == false) {
            print $bytime1;} ?>">
          ～
          <input type="time" name="bytime2" value="<?php if (empty($bytime2) == false) {
            print $bytime2;} ?>">
          <br><br><br>
        </div>
        <!--time-->
      ...
      <div class="emotion">
        ...
        <div class="kibun">
          <label><img src="../favicon/kao1.png"><br>
            <input type="radio" name="emotion" value="余裕" <?php if (isset($emotion) == true) {
              if ($emotion == '余裕') { print 'checked'; } }?>>余裕
          </label>

          <label><img src="../favicon/kao2.png"><br>
            <input type="radio" name="emotion" value="普通" <?php if (isset($emotion) == true) {
              if ($emotion == '普通') { print 'checked';}}?>>普通
          </label>

          <label><img src="../favicon/kao3.png"><br>
            <input type="radio" name="emotion" value="余裕がない" <?php if (isset($emotion) == true) {
              if ($emotion == '余裕がない') { print 'checked';}} ?>>余裕がない
          </label>

          <label><img src="../favicon/kao4.png"><br>
            <input type="radio" name="emotion" value="忙しい" <?php if (isset($emotion) == true) {
            if ($emotion == '忙しい') { print 'checked';}}?>>忙しい
          </label>

          <label><img src="../favicon/kao5.png"><br>
            <input type="radio" name="emotion" value="手伝ってほしい" <?php if (isset($emotion) == true) {
            if ($emotion == '手伝ってほしい') { print 'checked';}}?>>手伝ってほしい
          </label>
        </div>
        <!--kibun-->
      </div>
    ...
    <div class="kouhan">
      <div class="kohan1">
        <div class="zikan">
          都合がいい時間 <br><br>
          <input type="time" name="time1" value="<?php if (empty($time1) == false) {
          print $time1;} ?>">
          ～
          <input type="time" name="time2" value="<?php if (empty($time2) == false) {
          print $time2;} ?>">
          <br><br><br>
        </div>
        <!--zikan-->
        <div class="tyui">
          質問時の注意事項 <br><br>
          <textarea class="area" name="attention" placeholder="※質問する前に見ておいてほしいことを書いてください。"><?php
